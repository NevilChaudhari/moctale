...
export default function Notification() {
  ...
  return (
    <div className="z-100 bg-black md:bg-black/30 md:backdrop-blur-md h-full md:h-auto w-full md:w-100 fixed md:mt-3 rounded-md md:border-white/20 md:border">
      {/* Title */}
